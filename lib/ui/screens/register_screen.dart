...
import 'package:tinder_app_flutter/ui/screens/questions/questionView.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Widget getSubScreen() {
    switch (_currentScreenIndex) {
      ...
      case 4: 
        return QuestionView(onChanged: () {setState(() {});}, question: questions.first);
      default:
        return Container();
    }
  }
  ...
  bool canContinueToNextSubScreen() {
    switch (_currentScreenIndex) {
      ...
      case 3:
        return (_userRegistration.email != '' && _userRegistration.password.length > 5);
      default:
        return false;
    }
  }
                  ...
                  child: (Question.done)
                      ? RoundedButton(
                          ...
                          onPressed: _isLoading == false
                              ? () => {registerUser()}
                              : null)
                      : _currentScreenIndex != (_endScreenIndex) ? RoundedButton(
                          text: 'CONTINUE',
                          onPressed: () => {
